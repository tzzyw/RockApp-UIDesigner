<%@ Page Language="C#" EnableEventValidation = "false" AutoEventWireup="true" CodeFile="NodeliveryCustomer.aspx.cs" Inherits="app_view_NodeliveryCustomer" %>
...
<head runat="server">
    ...
    <script src="../controller/nodeliveryCustomer.js"></script>
    <script type="text/javascript">
        function check全选_OnChange(checkAll) {
...
<body>
    <form id="form1" runat="server" style="height: 100%">
        ...
        <table style="width: 98%;">
            <tr>
                <td style="width: 15%; text-align: right">未提区间数选择:
                </td>
                <td style="width: 30%">
                    <asp:TextBox ID="txtbegin" runat="server" CssClass="smallInput" Width="35%"></asp:TextBox>--<asp:TextBox ID="txtend" runat="server" CssClass="smallInput" Width="35%"></asp:TextBox>
                </td>
                ...
                <td style="width: 35%; text-align: center">
                    ...
                    <asp:ImageButton ID="btn导出" runat="server" ImageUrl="../../Images/export.gif" CssClass="ImageButton"
                        OnClick="btn导出_Click" />
                    <asp:Button ID="btn禁用所有" runat="server" CssClass="toolbar" OnClick="btn禁用所有_Click"
                        Text="禁用所有" Width="67px" />
                </td>
            </tr>
        </table>
            ...
            <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="Grid" CellPadding="2"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="选择">
                        <HeaderTemplate>
                            <input type="checkbox" id="check全选" onclick="check全选_OnChange(this)" />全选                                                        
                        </HeaderTemplate>
                        <ItemStyle Width="8%" HorizontalAlign="Center"></ItemStyle>
                        <ItemTemplate>
                            <asp:CheckBox ID="chk选中客户" runat="server" Checked="false" />
                            <asp:Label ID="lbl客户ID" runat="server" Visible="false" Text='<%#DataBinder.Eval(Container.DataItem, "CustomerID")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="btn禁用" runat="server" CssClass="toolbar" Text="禁用" OnCommand="btn禁用_Click"
