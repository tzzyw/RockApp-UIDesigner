<%@ Page Language="C#" EnableEventValidation = "false" AutoEventWireup="true" CodeFile="CustomerQualityList.aspx.cs" Inherits="app_view_CustomerQualityList" %>
            ...
            <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="Grid" CellPadding="2"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        ...
                        <ItemTemplate>
                            <a href='CustomerQuality.html?ID=<%#DataBinder.Eval(Container.DataItem, "CustomerID")%>'
                                target="_blank">维护</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
