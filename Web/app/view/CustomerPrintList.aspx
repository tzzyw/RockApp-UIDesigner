<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="CustomerPrintList.aspx.cs" Inherits="app_view_CustomerPrintList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table style="width: 98%;">
            <tr>
                <td style="width: 15%; text-align: right">客户名称
                </td>
                <td style="width: 20%">
                    <asp:TextBox ID="txt客户名称" runat="server" CssClass="smallInput"></asp:TextBox>
                </td>
