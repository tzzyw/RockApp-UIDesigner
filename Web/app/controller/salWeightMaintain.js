...
$(function () {
    ...
    listGrid.attachEvent("onRowDblClicked", function (rowID, cIndex) {
        ...
        if ($('#llj').attr('checked')) {
            ...
            $("#sby").text("司磅员");
            //$("#txtlightOperator").val(decodeURIComponent($.cookie('userTrueName')));
            $("#txtlightOperator").val(measure.heavyOperator);
            $("#btn_Save").text("取消计量");
            editForm.height(250);
        }
        else {
    ...
    function getDataList() {
        ...
        if ($('#llj').attr('checked')) {
            sqlStr += " and Measure.State='已过毛重' and (Measure.Tare is null or Measure.Tare = 0) ";
        }
        ...
        if ($('#db').attr('checked')) {
            ...
            if ($('#maozhong').attr('checked')) {
                sqlStr += " and Measure.State='已过毛重' and Measure.Gross > 0";
            }
        }
    ...
    $("#btn_Save").click(function () {
        ...
        if ($('#llj').attr('checked')) {
            ...
            measure.heavyOperator = null;
            measure.netWeight = null;
            measure.tareTime = null;
            measure.grossTime = null;
            measure.state = "已提交";
