...
$(function () {
    //初始化系统通用变量
    var toolBar, dhxLayout, masterGrid, detailGrid, sqlStr, auditHistoryGrid,
    ...
    masterGrid.setHeader("序号,,打印,申请单编号,产品名称,创建日期,累计幅度大于50元,状态");
    ...
    masterGrid.attachEvent("onRowSelect", function (rowID, cIndex) {
        ...
        if (cIndex == 2) {
            window.open("PriceApplyPrint.html?ID=" + rowID);
        }
    });
    masterGrid.init();
