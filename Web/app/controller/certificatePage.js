...
$(function () {
    ...
    $.getScript('/LoadDomainJS.ashx?JsTypes=' + jsTypes, function () {
        ...
        if (examinationID == null) {
            IBusinessService.getLastExamination.productName = $("#product").val();
            rock.AjaxRequest(IBusinessService.getLastExamination, rock.exceptionFun);
            if (IBusinessService.getLastExamination.success) {
                (function (e) {
                    examination = e;
                    fillPage(examination);
                }(IBusinessService.getLastExamination.resultValue))
            }
        }
        else {
            ISystemService.getDynObjectByID.dynObjectID = examinationID;
    ...
    $("#btn_Save").click(function () {
        ...
        examination.productName = "工业己烷(外采)";
